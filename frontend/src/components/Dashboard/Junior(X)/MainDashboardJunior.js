...
import GraphBarStored from '../Common(X)/GraphBarStored'
import GraphBarWarehouse from '../Common(X)/GraphBarWarehouse'
                ...
                <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className='grid xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                        <div className="mt-10">
                            ...
                            <p className='text-md text-center mb-3' onClick={() => { toPage("ProductList") }}>전체보기</p>
                        ...
                        <div className="mt-10">
                            ...
                            <p className='text-md text-center mb-3' onClick={() => { toPage("WarehouseList") }}>전체보기</p>
                            <dl className="space-y-10 md:space-y-0 md:grid md:gap-x-8 md:gap-y-10">
                                <div className="relative">
                                    <GraphBarStored />
                                </div>
                        ...
                        <div className="mt-10">
                            ...
                            <p className='text-md text-center mb-3' onClick={() => { toPage("StockList") }}>전체보기</p>
                            <dl className="space-y-10 md:space-y-0 md:grid md:gap-x-8 md:gap-y-10">
                                <div className="relative">
                                    <GraphBarWarehouse />
                                </div>
